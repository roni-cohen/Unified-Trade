...
let _positions = [
  { id: 'pos1',  portfolioId: 'p1', userId: 'demo', ticker: 'AAPL',  shares: 20,  avgCost: 145.00, notes: 'Core holding' },
  { id: 'pos2',  portfolioId: 'p1', userId: 'demo', ticker: 'MSFT',  shares: 10,  avgCost: 280.00, notes: '' },
  { id: 'pos3',  portfolioId: 'p1', userId: 'demo', ticker: 'NVDA',  shares: 15,  avgCost: 420.00, notes: 'AI play — long term' },
  { id: 'pos4',  portfolioId: 'p2', userId: 'demo', ticker: 'META',  shares: 8,   avgCost: 310.00, notes: 'Reels monetisation' },
  { id: 'pos5',  portfolioId: 'p2', userId: 'demo', ticker: 'GOOGL', shares: 12,  avgCost: 130.00, notes: 'Search + Cloud' },
  { id: 'pos6',  portfolioId: 'p2', userId: 'demo', ticker: 'INTC',  shares: 30,  avgCost: 38.00,  notes: 'Turnaround bet' },
  { id: 'pos7',  portfolioId: 'p3', userId: 'demo', ticker: 'JNJ',   shares: 25,  avgCost: 155.00, notes: 'Dividend aristocrat' },
  { id: 'pos8',  portfolioId: 'p3', userId: 'demo', ticker: 'SPY',   shares: 5,   avgCost: 420.00, notes: 'Core index' },
  { id: 'pos9',  portfolioId: 'p3', userId: 'demo', ticker: 'VYM',   shares: 40,  avgCost: 105.00, notes: 'High yield ETF' },
]
...
export async function updatePosition(id, data) {
  _positions = _positions.map(p => p.id === id ? { ...p, ...data, shares: parseFloat(data.shares), avgCost: parseFloat(data.avgCost) } : p)
